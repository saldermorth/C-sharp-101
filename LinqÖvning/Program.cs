...
class Program
{
    ...
    static void InitializeData()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            int offset = i * 15; // 15 produkter per uppsättning
            inventory.AddRange(new List<Product>
        {
            new Product { Id = 1 + offset, Name = "Hammare", Category = "Verktyg", Quantity = 100, Price = 149.99m, LastRestocked = DateTime.Parse("2023-05-15") },
            new Product { Id = 2 + offset, Name = "Skruvmejsel", Category = "Verktyg", Quantity = 200, Price = 39.99m, LastRestocked = DateTime.Parse("2023-06-01") },
            new Product { Id = 3 + offset, Name = "Borrmaskin", Category = "Elverktyg", Quantity = 50, Price = 799.99m, LastRestocked = DateTime.Parse("2023-04-10") },
            new Product { Id = 4 + offset, Name = "Spik 100-pack", Category = "Fästmaterial", Quantity = 500, Price = 29.99m, LastRestocked = DateTime.Parse("2023-06-10") },
            new Product { Id = 5 + offset, Name = "Skruv 100-pack", Category = "Fästmaterial", Quantity = 600, Price = 39.99m, LastRestocked = DateTime.Parse("2023-06-05") },
            new Product { Id = 6 + offset, Name = "Målarpensel", Category = "Måleriutrustning", Quantity = 150, Price = 59.99m, LastRestocked = DateTime.Parse("2023-05-20") },
            new Product { Id = 7 + offset, Name = "Färgroller", Category = "Måleriutrustning", Quantity = 100, Price = 79.99m, LastRestocked = DateTime.Parse("2023-05-22") },
            new Product { Id = 8 + offset, Name = "Skyddsglasögon", Category = "Säkerhetsutrustning", Quantity = 200, Price = 129.99m, LastRestocked = DateTime.Parse("2023-04-25") },
            new Product { Id = 9 + offset, Name = "Hörselskydd", Category = "Säkerhetsutrustning", Quantity = 150, Price = 199.99m, LastRestocked = DateTime.Parse("2023-04-26") },
            new Product { Id = 10 + offset, Name = "Cirkelsåg", Category = "Elverktyg", Quantity = 30, Price = 1299.99m, LastRestocked = DateTime.Parse("2023-03-15") },
            new Product { Id = 11 + offset, Name = "Multimeter", Category = "Elverktyg", Quantity = 40, Price = 399.99m, LastRestocked = DateTime.Parse("2023-05-05") },
            new Product { Id = 12 + offset, Name = "Vattenpass", Category = "Verktyg", Quantity = 80, Price = 89.99m, LastRestocked = DateTime.Parse("2023-05-10") },
            new Product { Id = 13 + offset, Name = "Arbetshandskar", Category = "Säkerhetsutrustning", Quantity = 300, Price = 49.99m, LastRestocked = DateTime.Parse("2023-06-02") },
            new Product { Id = 14 + offset, Name = "Murslev", Category = "Verktyg", Quantity = 60, Price = 69.99m, LastRestocked = DateTime.Parse("2023-05-18") },
            new Product { Id = 15 + offset, Name = "Målarfärg 10L", Category = "Måleriutrustning", Quantity = 40, Price = 449.99m, LastRestocked = DateTime.Parse("2023-05-25") }
        });
        }
